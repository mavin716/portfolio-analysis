...
public class PortfolioApp
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
           ...
           // If current download file timestamp before 6pm, then the fund prices are from the previous day.  
           ...
           portfolioService.loadFundAllocation(portfolio, ALLOCATION_FILE);
            ...
            //System.out.println("Total portfolio value: " + formatAsCurrencyString(portfolio.getTotalValue()));
...
//           portfolioService.rebalanceFunds(portfolio, EXCHANGE_INCREMENT, adjustments);
            ...
            // Calculate the funds to withdrawal from
           // move 500 to each mm
